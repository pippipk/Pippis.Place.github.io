class BUTTON{ //this is the class for the buttons that change the colour of the drawings
    constructor(x, y, w, h, col, col1, target){
        ...
        this.target = target; // the target is the rectangle class so this is what sends variables to the rectangle function when drawing the shapes
    ...
    mMove(e){
        ...
        if (this.x < this.xMouse && (this.x+this.w) > this.xMouse && this.yMouse > this.y && this.yMouse < (this.y+this.h)){
            ...
            this.col1 = "black"; // if the mouse is over the button the border colour of the button changes to black to show the user their mouse is over a button 
    ...
    text(){
        ...
        ctx.font=myFont
        ctx.fillText("SELECTED", this.x+35,(this.y+45));
    }
