...
// gives "rgba(204,0,0,1)"
ctx.strokeStyle = colArray[1][3] 
// gives "rgba(204,0,0,0.67)" the colour with some transparency
ctx.strokeStyle = colArray[2][3] 
// gives "rgba(204,0,0,0.33)" the colour with lots of transparency